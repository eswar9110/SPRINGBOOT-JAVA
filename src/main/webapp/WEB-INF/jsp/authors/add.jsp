...
<head>
    ...
    <title>Add Author - BookAuthor Management</title>
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-error {
            color: #f87171; font-size: 0.8rem; margin-top: 0.4rem;
        }
...
<div class="container">
    <div class="form-card">
        ...
        <form:form method="POST" action="${pageContext.request.contextPath}/authors/add" modelAttribute="author">
